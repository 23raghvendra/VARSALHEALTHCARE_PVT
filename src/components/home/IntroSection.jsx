        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-gray-50 p-8 rounded-lg transition-transform hover:-translate-y-2 duration-300">
            ...
            <div className="text-center">
              <Link href="/about#vision" className="inline-flex items-center text-varsal-blue hover:text-varsal-darkblue font-medium">
          ...
          <div className="bg-gray-50 p-8 rounded-lg transition-transform hover:-translate-y-2 duration-300">
            ...
            <div className="text-center">
              <Link href="/products" className="inline-flex items-center text-varsal-blue hover:text-varsal-darkblue font-medium">
          ...
          <div className="bg-gray-50 p-8 rounded-lg transition-transform hover:-translate-y-2 duration-300">
            ...
            <div className="text-center">
              <Link href="/about#values" className="inline-flex items-center text-varsal-blue hover:text-varsal-darkblue font-medium">
